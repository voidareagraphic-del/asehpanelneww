...
const fa: Translations = {
  ...
  products: {
    ...
    items: [
      ...
      { name: "پانل پیچ مخفی", subtitle: "سیستم اتصال پنهان", description: "پانل‌های نمای معماری با سیستم اتصال پنهان برای سطوح یکپارچه و ممتاز.", applications: ["نمای هتل‌ها", "مراکز خرید", "ساختمان‌های اداری"] },
      { name: "پانل سردخانه", subtitle: "پانل‌های عایق اتصال دو فاق و زبانه", description: "پانل‌های مهندسی‌شده دارای کمترین انتقال حرارت در محل اتصال", applications: ["انبارهای سردخانه", "فرآوری مواد غذایی", "داروسازی"] },
      { name: "پانل کلین‌روم", subtitle: "سیستم یکپارچه آنتی باکتریال", description: "پانل‌های بدون آلودگی برای محیط‌های کنترل‌شده. سطح ضدباکتری، درزهای یکپارچه، دارای گواهینامه HACCP.", applications: ["کارخانه‌های داروسازی", "کارخانه‌های مواد غذایی", "تولید نیمه‌هادی"] },
    ],
    specsStrip: [
