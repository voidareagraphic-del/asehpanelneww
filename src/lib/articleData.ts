    ...
    sections: {
      ...
      fa: [
        ...
        },
        {
          ...
          body: "برای هر کاربرد سردخانه‌ای زیر -20°C، زنجیره سرمای داروسازی یا اتاق تمیز، PIR با شاخص بالا مشخصات توصیه‌شده است. هزینه اضافی مواد با مصرف انرژی کمتر در طول عمر ساختمان و کاهش تعمیرات و نگهداری جبران می‌شود. PUR همچنان یک گزینه مقرون‌به‌صرفه برای کاربردهای دمای محیطی غیرحیاتی مانند پارتیشن‌های اداری و روکش دیوار صنعتی سبک باقی می‌ماند.",
        },
      ],
    },
  },
